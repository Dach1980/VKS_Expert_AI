...
import './training.js?v=20260909-1';
const SECTION_LABELS={dashboard:'Dashboard',norms:'Нормы',docs:'Документация',checks:'Замечания',reports:'Отчёты',settings:'Настройки',training:'Обучение AI'};
