...
(function installNormAmendmentLabelFix() {
  function amendmentFromFilename(filename) {
    var text = String(filename || '')
      .replace(/[\u00A0\u202F]/g, ' ')
      .replace(/[_-]+/g, ' ');
    // JS \b is ASCII-oriented and does not treat Cyrillic letters as word characters.
  ...
  function install() {
    ...
    console.log('[Project Expert AI][Norms] final Cyrillic-safe amendment label guard loaded');
  }
