"""Controlled Vision diagnostic using the exact production VK Skill prompt with enough output budget for completion."""
...
def main() -> None:
    parser = argparse.ArgumentParser(
        description="Controlled Vision test with the exact production VK Skill prompt and a complete output budget"
    )
    ...
    print("=== VISION SKILL COMPLETE TEST ===")
    print()
    print("IMAGE:")
    ...
    print()
    print("NOTE:")
    print("  same page, model selection, image payload and exact Skill prompt as Test #4")
    print("  only diagnostic change: max_tokens increased from 1400 to 3000")
    ...
    print("  raw response is printed before any production parsing or filtering")
    print()
